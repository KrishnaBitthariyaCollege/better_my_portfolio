      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-lg max-w-3xl mx-auto leading-relaxed">
            Krishna is an enthusiastic and curious learner exploring the world of
            technology. Passionate about Flutter, Firebase, and cross-platform
            development, he is actively building real-world projects while
            learning modern tools like Riverpod, barcode systems, and cloud
            integration. Eager to grow in app development and AI, Krishna is
            committed to turning ideas into impactful digital solutions.
          </p>
        </div>
